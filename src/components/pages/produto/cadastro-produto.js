        ...
        <form>
            <div className="row">
                ...
                <div className="form-group col-md-3">
                    ...
                    <input type="text" className="form-control" id="inputEmail4" placeholder="Nome Produto" />
                </div>
                <div className="form-group col-md-5">
                    <label for="inputPassword4">Marca:</label>
                    <input type="text" className="form-control" id="inputPassword4" placeholder="Marca" />
                </div>
