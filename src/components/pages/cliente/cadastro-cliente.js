            ...
            <form>
                <div className="row">
                    ...
                    <div className="form-group col-md-3">
                        ...
                        <input type="text" className="form-control" id="inputEmail4" placeholder="000.000.000-00" />
                    </div>
                    ...
                    <div className="form-group col-md-6">
                        ...
                        <input type="email" className="form-control" id="inputEmail4" placeholder="Escreva aqui..." />
                    </div>
